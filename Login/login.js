document.addEventListener('DOMContentLoaded', function() {
    ...
    function togglePasswordVisibility() {
        ...
        if (passwordInput.type === 'password') {
            ...
            togglePasswordIcon.className = 'ri-eye-fill'; // Assicurati di avere un'icona appropriata per indicare la password nascosta
        } else {
            passwordInput.type = 'password';
            // Cambia l'icona per indicare che la password è nascosta
            togglePasswordIcon.className = 'ri-eye-off-fill'; // Assicurati di avere un'icona appropriata per indicare la password visibile
        }
    }
